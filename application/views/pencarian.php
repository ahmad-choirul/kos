...
<body>
  <nav class="navbar sticky-top navbar-expand-lg navbar-custom bg-custom">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <!-- <form class="" action="<?php echo site_url('Ckos/cari');  ?>" method="post"> -->
        ...
        <input class="form-control offset-md-7 col-md-2 col-8" type="text" name="kata" id="kata" style="margin-right:10px;" placeholder="Search" aria-label="Search">
        <button class="btn btn-outline-primary" style="margin-right:10px;" onclick="search()" title="Search">Search</button>
        <!-- </form> -->
        <!-- </form> -->
  ...
  <script type="text/javascript">
    function search() {
      var b = document.getElementById("kata").value;
      console.log(b);
      var form = $('<form action=" <?php echo site_url("/Ckos/cari"); ?>" method="POST">' +
        '<input type="hidden" name="kata" value="' + b + '" />'+
        '</form>');
      $('body').append(form);
      $(form).submit();
    }
