		...
		<div class="box box-info">
			...
			<form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo site_url('Csimpanan/savesimpanan'); ?>">
				<div class="box-body">
					...
					<div class="form-group">
						<label for="tgl_simpanan" class="col-sm-2 control-label">Tanggal Pemubuatan</label>
						<div class="col-sm-10">
				...
				<div class="box-footer">
					<a href="<php"></a>
					<a class="btn btn-default" href="<?php echo site_url('Csimpanan/pembuatan') ?>">Batal</a>
