...
<section class="content"> 
  <form role="form" enctype="multipart/form-data" action="<?php echo site_url('Cpinjaman/updateverifikasipinjaman'); ?>" method="post">
    <div class="row">
            ...
            <div class="box-body">
              <?php foreach($daftar as $u){ ?>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="jumlah_pinjaman" name="jumlah_pinjaman" readonly type="text" value="<?php echo $u->jumlah_pinjaman ?>">
                ...
                <div class="form-group row" style="background: transparent;">
                  ...
                  if ($u->status == '2') {
                    ?>
                    <div class="col-sm-4">
                      <a href="<?php echo site_url('Cpinjaman') ?>" class="btn btn-default btn-block"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                    </div>
                    <div class="col-sm-4">
                      <a href="<?php echo site_url('Cpinjaman/print') ?>" class="btn btn-primary btn-block"><i class="fa fa-fw fa-print"></i> Print</a>
                    </div>
                    <div class="col-sm-4">
                     <button type="submit" value="terima" name="submit" class="btn btn-success btn-block"><i class="fa fa-check-square-o"></i> Verifikasi Pencairan</button>
                   </div>
                   <?php 
                 } elseif ($u->status == '3') {
                  ?>
                  ...
                  <div class="col-sm-4">
                    <button type="submit" value="lunas" name="submit" class="btn btn-success btn-block"><i class="fa fa-check-square-o"></i> Lunas</button>
                  </div>
                  <?php 
                } else {
                 ?>
