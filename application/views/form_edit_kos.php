							...
							<div class="box-body">
								<?php foreach($datakos as $u){ ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" placeholder="Masukkan Deskripsi parkir Kos anda dan batasi dengan tanda koma (,)" name="parkir" id="parkir" value="<?php echo $u->parkir;?>">
